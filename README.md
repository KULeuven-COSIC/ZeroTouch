...
The repository contains source code and resources supporting the paper `ZeroTouch: Reinforcing RSS for Secure Geofencing`, which appeared at [SACMAT 2025](https://www.sacmat.org/2025/call-for-papers.php).
