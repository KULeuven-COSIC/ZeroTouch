...
% hold on;
% 
% % Room 1, Random Placement, Proximity (Blue)
% b1 = boxchart(positions, random_p_means_room_1, 'BoxFaceColor', 'b');
% errorbar(positions, random_p_means_room_1, random_p_deviation_room_1, 'b.', 'LineWidth', 1.5);
% 
% % Room 1, Random Placement, Full (Green)
% b2 = boxchart(positions, random_f_means_room_1, 'BoxFaceColor', 'g');
% errorbar(positions, random_f_means_room_1, random_f_deviation_room_1, 'g.', 'LineWidth', 1.5);
% 
% % Room 2, Random Placement, Proximity (Magenta)
% b3 = boxchart(positions, random_p_means_room_2, 'BoxFaceColor', 'm');
% errorbar(positions, random_p_means_room_2, random_p_deviation_room_2, 'm.', 'LineWidth', 1.5);
% 
% % Room 2, Random Placement, Full (Red)
% b4 = boxchart(positions, random_f_means_room_2, 'BoxFaceColor', 'r');
% errorbar(positions, random_f_means_room_2, random_f_deviation_room_2, 'r.', 'LineWidth', 1.5);
% 
% % Labels and title
% xlabel('Number of Anchor Nodes');
% ylabel('Average Accuracy');
% title('Box Plot Representation with Mean and Standard Deviation');
% grid on;
% 
% % Legend
% legend([b1 b2 b3 b4], {'Room 1, Random Placement, Proximity', ...
%                         'Room 1, Random Placement, Full', ...
%                         'Room 2, Random Placement, Proximity', ...
%                         'Room 2, Random Placement, Full'}, ...
%                         'Location', 'Best');
% hold off;
